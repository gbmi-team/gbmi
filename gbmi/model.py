...
# TODO([REDACTED] or [REDACTED]): figure out why we need this for .ckpt state_dicts and write documentation or remove
...
def train_or_load_model(
    ...
    # TODO([REDACTED] or [REDACTED], low-ish priority): fix model checkpointing, it doesn't seem to work
