...
def log_tensor(
    ...
    **kwargs,
    ...
    # I'd like to do https://docs.wandb.ai/guides/track/log/plots#matplotlib-and-plotly-plots but am not sure how cf https://github.com/[REDACTED][REDACTED]/guarantees-based-mechanistic-interpretability/issues/33 cc [REDACTED]
